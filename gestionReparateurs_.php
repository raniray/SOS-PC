...
while($row = $select->fetch()){
  ?>
    <tr id="<?php echo $row['idUser']?>" name="<?php echo $row['idUser']?>">
    ...
    <input type="radio" id="<?php echo "Rep4"; ?>" value="4"/><label  onclick="evaluer(<?php echo $row['idUser']?>,'4');" for="star4" title="Très bien">4 stars</label>
    <input type="radio" id="<?php echo "Rep3"; ?>" value="3" onclick="evaluer(<?php echo $row['idUser']?>,'3');"/><label for="star3" title="Bien">3 stars</label>
    <input type="radio" id="<?php echo "Rep2"; ?>" value="2"/><label onclick="evaluer(<?php echo $row['idUser']?>,'2');" for="star2" title="Un peu mauvais">2 stars</label>
    <input type="radio" id="<?php echo "Rep1"; ?>" value="1" onclick="evaluer(<?php echo $row['idUser']?>,'1');" /><label for="star1" title="Mauvais">1 star</label>
